      ...
      <Container maxWidth="md" sx={{ py: 6 }}>
        ...
        <CustomAccordion square expanded={activeItem === "panel1"} onChange={handleChange("panel1")}>
          <CustomAccordionSummary
              expandIcon={<AddIcon sx={{ color: "common.white", fontSize: "1.5rem" }} />}
          ...
          <AccordionDetails>
            ...
            <Typography variant="h5">
              ...
              single ad – all for one low monthly price. There always
        ...
        <CustomAccordion square expanded={activeItem === "panel2"} onChange={handleChange("panel2")}>
          ...
          >
           ...
           variant="h5"
           >
            How much does Netflix cost?</Typography>
          </CustomAccordionSummary>
          <AccordionDetails>
            <Typography variant="h5" mb={4}>
        ...
        <CustomAccordion square expanded={activeItem === "panel5"} onChange={handleChange("panel5")}>
          ...
          >
           ...
           variant="h5"
           >
            What can i watch on Netflix?</Typography>
          </CustomAccordionSummary>
          <AccordionDetails>
            <Typography variant="h5" mb={4}>
        ...
        <CustomAccordion square expanded={activeItem === "panel6"} onChange={handleChange("panel6")}>
          ...
          >
           ...
           variant="h5"
           >
            Is Netflix good for kids?</Typography>
          </CustomAccordionSummary>
          <AccordionDetails>
            <Typography variant="h5" mb={4}>
            ...
            <Typography variant="h5">
               Kids profiles come with PIN-protected parental controls that let you restrict the maturity rating of content kids can watch and block specific titles you dont want kids to see.
            </Typography>
          </AccordionDetails>
        </CustomAccordion>
        </Stack>
